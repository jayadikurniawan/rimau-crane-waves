...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us - PT Rimau Trisukses Perkasa | Get in Touch</title>
        <meta name="description" content="Contact PT Rimau Trisukses Perkasa for floating crane services. Located in Jakarta with 24/7 emergency response across Indonesian ports." />
        <meta name="keywords" content="contact Rimau Trisukses Perkasa, floating crane inquiry, crane rental contact, maritime services contact Indonesia" />
      </Helmet>
