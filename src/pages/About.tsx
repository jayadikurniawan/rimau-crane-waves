...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - PT Rimau Trisukses Perkasa | Floating Crane Services Indonesia</title>
        <meta name="description" content="Learn about PT Rimau Trisukses Perkasa's commitment to excellence in maritime services, floating crane operations, and port equipment rental across Indonesia." />
        <meta name="keywords" content="about Rimau Trisukses Perkasa, floating crane company, maritime services Indonesia, crane rental company history" />
      </Helmet>
